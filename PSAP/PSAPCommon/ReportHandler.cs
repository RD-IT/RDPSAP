...
namespace PSAP.PSAPCommon
{
    public class ReportHandler
    {
        ...
        public List<Parameter> GetSystemInfo_ParamList()
        {
            ...
            p6.Name = "公司邮箱";
            p6.Value = SystemInfo.CompE_Mail;
            paramList.Add(p6);
            Parameter p7 = new Parameter();
            p7.Name = "公司网址";
            p7.Value = SystemInfo.CompWebSite;
            paramList.Add(p7);
            Parameter p8 = new Parameter();
            p8.Name = "公司商标";
            p8.Value = SystemInfo.CompImage;
            paramList.Add(p8);
            Parameter p9 = new Parameter();
            p9.Name = "打印时间";
            p9.Value = BaseSQL.GetServerDateTime();
            paramList.Add(p9);
            Parameter p10 = new Parameter();
            p10.Name = "打印人";
            p10.Value = SystemInfo.user.EmpName;
            paramList.Add(p10);
            return paramList;
        }
