...
namespace PSAP.DAO.INVDAO
{
    public class FrmSpecialWarehouseWarrantDAO
    {
        ...
        public void QuerySpecialWarehouseWarrantHead(DataTable queryDataTable, string beginDateStr, string endDateStr, string reqDepStr, int repertoryIdInt, int locationIdInt, int warehouseStateInt, string preparedStr, int approverInt, string commonStr, bool nullTable)
        {
            BaseSQL.Query(QuerySpecialWarehouseWarrantHead_SQL(beginDateStr, endDateStr, reqDepStr, repertoryIdInt, locationIdInt, warehouseStateInt, preparedStr, approverInt, commonStr, nullTable), queryDataTable);
        }

        /// <summary>
        /// 查询预算外入库单表头的SQL
        /// </summary>
        public string QuerySpecialWarehouseWarrantHead_SQL(string beginDateStr, string endDateStr, string reqDepStr, int repertoryIdInt, int locationIdInt, int warehouseStateInt, string preparedStr, int approverInt, string commonStr, bool nullTable)
        {
            string sqlStr = " 1=1";
            if (beginDateStr != "")
            {
